...
- [x] `context/specs/2026-04-30-opensource-readiness/spec.md` frontmatter contains a `related:` list with at least one wikilink to a learning. Verified by `awk '/^---$/{n++} n==2{exit} {print}' <file> | grep -c '^\s*-\s*"\[\['` ≥ 1.
