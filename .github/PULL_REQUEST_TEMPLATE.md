...
- [ ] (For validator changes) Ran `UV_CACHE_DIR=/tmp/specwright-uv-cache uv run --offline --with PyYAML python3 tests/skills/test_validation.py` and `bash tests/validate-spec/run.sh`.
