...
- The `.agents/`, `.claude/`, and `.memex/` directories — maintainer-local content (dogfooded memex output and personal knowledge vault). Not consumed by `npx skills add` and not part of the published skill surface.
