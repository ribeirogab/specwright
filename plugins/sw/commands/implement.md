...
Run the specwright **implement** skill. Read `${CLAUDE_PLUGIN_ROOT}/skills/implement/SKILL.md` and follow its instructions exactly, treating `$ARGUMENTS` as the skill's input.
