...
- [ ] Step 2: Git-history ordering (AC-2): on the feature branch, `git log --oneline --diff-filter=A -- '.specwright/issues/*/issue.md' '.specwright/issues/*/spec.md'` — issue.md's adding commit predates spec.md/tasks.md's.
