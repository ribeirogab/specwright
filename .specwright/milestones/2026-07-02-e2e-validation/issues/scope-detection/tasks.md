...
- [ ] **Step 1: Create the evidence folder and transcript file**
...
- [ ] **Step 2: Spawn the session-under-test with the neutral framing prompt + opening user message**
...
- [ ] **Step 3: Record the exchange and reply per the policy until the session stops**
...
- [ ] **Step 1: AC-1 checks over the transcript**
...
- [ ] **Step 2: AC-2 checks in the sandbox**
...
- [ ] **Step 3: Sandbox integrity check**
...
- [ ] **Step 4: Commit the artifact evidence**
...
- [ ] **Step 1: Spawn the session with the neutral framing + tiny request**
...
- [ ] **Step 2: Record and reply per policy until the session stops**
...
- [ ] **Step 1: Write one verdict per check**
...
- [ ] **Step 2: Runtime verification pass**
...
- [ ] **Step 3: Sandbox quality gate re-check**
